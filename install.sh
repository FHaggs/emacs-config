...
#   Defaults to 'https://github.com/FHaggs/emacs-config.git'
# -i/--into
...
usage() {
    ...
    printf "  \t \t \t \t Defaults to 'https://github.com/FHaggs/emacs-config.git'.\n"
...
[ -z "$PRELUDE_URL" ] && PRELUDE_URL="https://github.com/FHaggs/emacs-config.git"
